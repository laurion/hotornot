      ...
      if(objAgain != null){
    	  var score = objAgain.get('score');
      	  res.end(JSON.stringify(score));
  	   	  ...
  	   	  var newobj = new Parse.Object('ferdinand');
...
function loadRootPage(req,res,next) {
   ...
   var obj = new Parse.Object('ferdinand');
   var query = new Parse.Query('ferdinand');
   var queryCurrentUser = new Parse.Query('ferdinand');
   ...
   query.find().then(function(users) {// query to fetch top scorers
	  ...
	  var data = {
        ...
        method: 'POST',
        json: true,
        body: {leaderboard_list: users, cluster : "ferdinand", password:"4loc4"}
     };
   ...
   var cardOne,cardTwo;
    var postUrl = "http://52.31.174.126:8001/api/saveVote";
     ...
     var data = {
        ...
        method: 'POST',
        json: true,
        body: {fbId: sessid, cluster : "ferdinand", password:"4loc4"}
    };
    return Promise.resolve(requestLib(data)).then(function(redis ){
          ...
          var obj = new Parse.Object('ferdinand');
  		    var queryUser = new Parse.Query('ferdinand');
              ...
              user1 = users[0];
              var queryUser2 = new Parse.Query('ferdinand');
...
router.post("/interested_in", function(req, res){
	...
	var sessid = req.session.id;
     ...
     var data = {
        ...
        method: 'POST',
        json: true,
        body: {sessionId: sessid, cluster : "ferdinand", password:"4loc4", gender: req.body.interested_in}
     };
   requestLib(data);
